...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("haaaiiii", "Aku ada pertanyaan nih buat kamu", "question").then(function () {
    Swal.fire("Jawab yang jujur ya!").then(function () {
      Swal.fire("Jng Bohongg", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${nama} kamu sayang sama ${Ade}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${Me} juga sayang banget sama ${nama}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih ya udah sayang ${Aku} ${val}%`).then(function () {
                    Swal.fire({
                      title: `${nama} kangen ga sm ${Aku}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      if (result.isConfirmed) {
                        ...
                        Swal.fire('yahhh , emang ga kangen parah', '', 'error').then(function () {
